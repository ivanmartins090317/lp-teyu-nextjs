      ...
      <div className="container mx-auto px-4">
        ...
        {/* <div className="text-center mt-16 animate-fade-in">
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl max-w-4xl mx-auto">
            <h3 className="font-playfair font-bold text-2xl md:text-3xl text-primary mb-4">
              Não encontrou o que procura?
            </h3>
            <p className="font-source text-neutral-600 mb-6">
              Temos uma rede de profissionais especializados em diversos segmentos. Entre
              em contato e encontraremos a solução perfeita para você.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-primary hover:bg-primary/90 text-white font-source font-semibold px-8 py-3 rounded-lg transition-all hover:scale-105">
                Ver Todos os Serviços
              </button>
              <button className="border-2 border-primary text-primary hover:bg-primary hover:text-white font-source font-semibold px-8 py-3 rounded-lg transition-all">
                Solicitar Orçamento
              </button>
            </div>
          </div>
